...
public class EmployeeData {
    private static final String DB_URL = "jdbc:postgresql://localhost:5432/employee_db";  // Replace with actual host and port
    private static final String DB_USERNAME = "postgres";  // Replace with your actual username
    private static final String DB_PASSWORD = "1234";  // Replace with your actual password
